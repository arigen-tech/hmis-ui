...
export const SWITCH_USER_CONTEXT = `/authController/switchContext`;
...
export const OPD_TREATMENT_TEMPLATE_GET_ALL = `${OPD_TEMPLATE}/getAllTreatmentTemplate/1`;
...
export const MAS_BLOOD_COMPONENT_GET_ALL = `${MAS_BLOOD_COMPONENT}/getAll/1`;
...
export const GET_PREVIOUS_OPD_PSYCHIATRIST_DETAILS_HISTORY = `/opd/getPreviousOpdPsychiatristDetailsHistory`;
...
export const GET_PENDING_BLOOD_REQUESTS = `/bloodBank/getAllPendingBloodRequests`;
...
export const GET_ALLOCATED_BLOOD_REQUEST_LIST = `/bloodBank/getAllocatedBloodRequestList`;
export const SAVE_CROSSMATCH = `/bloodBank/saveCrossmatch`;
export const GET_PENDING_BLOOD_ISSUE = `/bloodBank/getPendingBloodIssue`;
export const SAVE_BLOOD_ISSUE = `/bloodBank/issueBlood`;
export const ACKNOWLEDGE_BLOOD_REQUEST = `/bloodBank/acknowledgeBloodRequest`;
export const UPDATE_BLOOD_ISSUE_AND_TRACKING_STATUS = `/bloodBank/updateBloodIssueAndTrackingStatus`;
...
export const PENDING_MANDATORY_TESTING_LIST =
  "/bloodBank/pendingForMandatoryTestingList";
...
export const STOCK_REPORT_SUMMARY = `${ALL_REPORTS}/stockReportSummary`;
export const STOCK_REPORT_DETAIL = `${ALL_REPORTS}/stockReportDetail`;
...
export const LAB_RADIO_BILLING_DETAILS =
  "/billing/getLabRadiologyBillingDetails";
...
export const GET_WARD_WISE_INPATIENT = `/ipd/getWardWiseInpatient`;
