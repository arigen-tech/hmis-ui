...
export const SELECT_INVESTIGATIONS_ERROR_MSG =
  "Please select at least one investigation or package.";
export const INVALID_INVESTIGATION_ERROR =
  "One or more selected rows have no valid investigation/package. Please select from dropdown.";
export const INVALID_PATIENT_ID =
  "Patient ID not found. Please go back and try again.";
export const INVALID_INVESTIGATION_ID =
  "No valid items found for registration. Please check the investigation data.";
export const REGISTRATION = "Registered !";
export const REGISTRATION_SUCCESS_MSG =
  "New billing header created Successfully. Billing ID:";
export const REGISTRATION_ERR_MSG = "Registration Error!";
export const PAYMENT_ERROR =
  "Please select at least one investigation or package for payment.";
...
export const ADD_ROW_WARNING =
  "Please fill investigation/package name before adding new row.";
export const DUPLICATE = "Duplicate Found!";
export const DUPLICATE_PATIENT = "A patient with these details already exists.";
export const SUCCESS = "Success!";
export const LAB_REG_SUCC_MSG =
  "Patient and Lab registered successfully! Redirecting to payment.";
export const WARNING = "Warning";
export const INV_PRICE_WARNING_MSG =
  "Price has not been configured for this Investigation";
export const PACKAGE_PRICE_WARNING_MSG =
  "Price has not been configured for this Package";
export const MISSING_MANDOTORY_FIELD = "Missing Mandatory Fields";
export const MISSING_MANDOTORY_FIELD_MSG =
...
//MainChargecode
export const FETCH_MAIN_CHARGE_CODE_ERR_MSG =
  "Failed to load main charge code data";
export const DUPLICATE_MAIN_CHARGE_CODE_MSG =
  "Main charge code with the same code already exists!";
export const UPDATE_MAIN_CHARGE_CODE_SUCC_MSG =
  "Main charge code updated successfully!";
export const ADD_MAIN_CHARGE_CODE_SUCC_MSG =
  "New main charge code added successfully!";

//PendingForResultEntry
export const FETCH_RESULT_VALIDATE_ERR_MSG =
  "Failed to load pending result entries";
export const RESULT_ENTRY_WARN_MSG =
  "Please enter at least one result before submitting";
export const FETCH_AUTO_FILL_ERR_MSG =
  "Missing required data. Please contact administrator.";
...
export const SAMPLE_COLLECTION_SUCC_MSG =
  "Sample collection data saved successfully!";
...
export const RESULT_VALIDATE_WARN_MSG =
  "Please validate or reject at least one investigation before submitting.";
export const RESULT_SELECT_WARN_MSG =
  "No investigations selected for validation.";
export const RESULT_VALIDATE_ERR_MSG = "Failed to validate results";
export const RESULT_VALIDATE_SUCC_MSG =
  "Validation has been done successfully! Do you want to print the report?";

//ViewDownload
export const FETCH_RESULT_DATA_ERR_MSG =
  "No result data found. Redirecting back...";
export const INVALID_ORDER_ID_ERR_MSG = "Order ID not found";
export const LAB_REPORT_GENERATION_ERR_MSG =
  "Error generating lab report. Please try again.";
export const LAB_REPORT_PRINT_ERR_MSG =
  "Error generating lab report. Please try again.";

//Sample Collection Master
export const FETCH_SAMPLE_COLLECTION_ERR_MSG =
  "Failed to load sample collection data";
export const DUPLICATE_SAMPLE_COLLECTION_ERR_MSG =
  "Sample collection with the same code already exists!";
export const UPDATE_SAMPLE_COLLECTION_SUCC_MSG =
  "Sample collection updated successfully!";
export const ADD_SAMPLE_COLLECTION_SUCC_MSG =
  "New sample collection added successfully!";

//SasmpleValidation
export const FETCH_SAMPLE_VALIDATIONS_ERR_MSG =
  "Failed to load pending validation samples";
export const VALIDATION_WARN_MSG =
  "Please make a decision for ALL investigations. Each row must be either Accepted or Rejected.";
export const REJECT_REASON_WARN_MSG =
  "Please provide a reason for all rejected investigations.";
export const VALIDATION_SUCC_MSG = "Investigations validated successfully!";

//SubchargeCode
export const MIS_MATCH_ERR_MSG =
...
export const DUPLICATE_SUB_CHARGE_CODE_ERR_MSG =
  "A sub charge code with this code already exists!";
export const UPDATE_SUB_CHARGE_CODE_SUCC_MSG =
  "Sub charge code updated successfully!";
export const ADD_SUB_CHARGE_CODE_SUCC_MSG =
  "New sub charge code added successfully!";
...
export const PATIENT_NOT_FOUND_WARN_MSG =
  "No patients found matching your criteria";
export const DUPLICATE_FOUND = "Duplicate Found!";
export const LAB_BOOKING_SUCC_MSG =
  "Lab booking registered successfully! Redirecting to payment.";
...
export const DUPLICATE_PACKAGE_WARN_MSG =
  "This package is already added for this date.";
export const DUPLICATE_INV_INCLUDE_PACKAGE =
  "This investigation is already added or included in a package for this date.";
export const DUPLICATE_INV_PACKAGE_WARN_MSG =
  "Duplicate found! Please remove the duplicate before proceeding.";
export const COMMON_INV_IN_PACKAGES =
  "Cannot add package because it contains investigations that are already included in other selected packages.";
export const DUPLICATE_PACKAGE_WRT_INV =
  "Cannot add package because it contains investigations that are already selected individually";
...
export const SELECT_ROW_TO_EDIT_WARN_MSG =
  "Please select at least one row to edit before updating.";
...
export const FETCH_DROP_DOWN_ERR_MSG =
  "Some options could not be loaded. Please try again later";
...
export const DUPLICATE_BED_STATUS =
  "Bed Status with the same name already exists!";
...
export const DUPLICATE_CARE_LEVEL =
  "Care level with the same name already exists!";
...
export const DUPLICATE_DEPARTMENT =
  "Department with the same code, name, or number already exists!";
...
export const DUPLICATE_DIET_PREFERENCE =
  "Diet preference with same name already exists!";
export const UPDATE_DIET_PREFERENCE_SUCC_MSG =
  "Diet preference updated successfully!";
export const ADD_DIET_PREFERENCE_SUCC_MSG =
  "New diet preference added successfully!";

//DietScheduleMaster

export const FETCH_DIET_SCHEDULE_ERR_MSG = "Failed to load diet schedules";
export const DUPLICATE_DIET_SCHEDULE =
  "Diet schedule with same status name already exists!";
export const UPDATE_DIET_SCHEDULE_SUCC_MSG =
  "Diet schedule updated successfully!";
export const ADD_DIET_SCHEDULE_SUCC_MSG =
  "New diet schedule added successfully!";
...
export const FETCH_FAMILY_HISTROY_ERR_MSG =
  "Failed to load family history data";
export const DUPLICATE_FAMILY_HISTORY = "Family history name already exists!";
export const UPDATE_FAMILY_HISTORY_SUCC_MSG =
  "Family history updated successfully!";
export const ADD_FAMILY_HISTORY_SUCC_MSG =
  "New family history added successfully!";
...
export const UPDATE_INTAKE_TYPE_SUCC_MSG =
  "Intake item type updated successfully!";
export const ADD_INTAKE_TYPE_SUCC_MSG =
  "New intake item type added successfully!";

//InvestigationCategoryMaster

export const FETCH_INV_CATEGORY_ERR_MSG =
  "Failed to load  investigation categories";
export const DUPLICATE_INV_CATEGORY =
  "Investigation category with the same name already exists!";
export const UPDATE_INV_CATEGORY_SUCC_MSG =
  "Investigation category updated successfully!";
export const ADD_INV_CATEGORY_SUCC_MSG =
  "New investigation category added successfully!";

//InvestigationMethodologyMaster

export const FETCH_INV_METHODOLOGY_ERR_MSG =
  "Failed to load  investigation methodologies";
export const DUPLICATE_INV_METHODOLOGY =
  "Investigation methodology with the same name already exists!";
export const UPDATE_INV_METHODOLOGY_SUCC_MSG =
  "Investigation methodology updated successfully!";
export const ADD_INV_METHODOLOGY_SUCC_MSG =
  "New investigation methodology added successfully!";
...
export const UPDATE_TWICE_SUB_INV_ERR_MSG =
  "You’ve already made this update. To make another change please start new session";
export const UPDATE_SUB_INV_ERR_MSG = "Failed to update sub-investigations";
export const UPDATE_SUB_INV_SUCC_MSG =
  "Sub-investigations updated successfully!";

//MealTypeMaster

export const FETCH_MEAL_TYPE_ERR_MSG = "Failed to load  meal types";
export const DUPLICATE_MEAL_TYPE =
  "Meal type with the same name already exists!";
...
export const DUPLICATE_OUTPUT_TYPE =
  "Output type with the same name already exists!";
...
export const DUPLICATE_PATIENT_ACUITY =
  "Patient acuity with the same name already exists!";
export const UPDATE_PATIENT_ACUITY_SUCC_MSG =
  "Patient acuity updated successfully!";
export const ADD_PATIENT_ACUITY_SUCC_MSG =
  "New patient acuity added successfully!";

//ProcedureTypeMaster

export const FETCH_PROCEDURE_TYPE_ERR_MSG = "Failed to load procedure types";
export const DUPLICATE_PROCEDURE_TYPE =
  "Procedure type with the same name already exists!";
export const UPDATE_PROCEDURE_TYPE_SUCC_MSG =
  "Procedure type updated successfully!";
export const ADD_PROCEDURE_TYPE_SUCC_MSG =
  "New procedure type added successfully!";
export const ACTIVATE_PROCEDURE_TYPE_SUCC_MSG =
  "Procedure type activated successfully!";
export const ACTIVATE_PROCEDURE_TYPE_ERR_MSG =
  "Fail to activate procedure type";

//ProcedureMaster

export const FETCH_PROCEDURE_ERR_MSG = "Failed to load procedures";
export const DUPLICATE_PROCEDURE =
...
export const DUPLICATE_ROOM_CAT =
  "Room category with the same name already exists!";
...
export const DUPLICATE_SAMPLE =
  "Sample with same code or description already exists!";
...
export const DUPLICATE_TREAT_ADV =
  "Treatment advice already exists for this department!";
export const UPDATE_TREAT_ADV_SUCC_MSG =
  "Treatment advice updated successfully!";
export const ADD_TREAT_ADV_SUCC_MSG =
  "New treatment advice added successfully!";

//wardCategoryMaster

export const DUPLICATE_WARD_CATEGORY =
  "Ward Category with the same name already exists!";
export const UPDATE_WARD_CATEGORY_SUCC_MSG =
  "Ward category updated successfully!";
export const ADD_WARD_CATEGORY_SUCC_MSG =
  "New ward category added successfully!";

//AdmissionStatusMaster

export const FETCH_ADMISSION_STATUS_ERR_MSG =
  "Failed to load admission status data";
export const DUPLICATE_ADMISSION_STATUS =
  "Admission Status Code already exists";
export const ADD_ADMISSION_STATUS_SUCC_MSG =
  "Admission Status added successfully!";
export const UPDATE_ADMISSION_STATUS_SUCC_MSG =
  "Admission Status updated successfully!";

//SpecialityMaster

export const ADD_SPECIALTY_SUCC_MSG = "Specialty Center added successfully!";
export const UPDATE_SPECIALTY_SUCC_MSG =
  "Specialty Center updated successfully!";
...
export const UPDATE_BILLING_POLICY_SUCC_MSG =
  "Billing Policy updated successfully!";
export const DUPLICATE_BILLING_POLICY = "Billing Policy already exists!";
export const FETCH_BILLING_POLICY_ERR_MSG =
  "Failed to load billing policy data";
...
export const UPDATE_SPECTACLE_USE_SUCC_MSG =
  "Spectacle Use updated successfully!";
export const FAIL_SPECTACLE_USE = "Operation failed";
export const UPDATE_FAIL_SPECTACLE_USE = "Status update failed";

//BookedStatusMaster

export const ADD_BOOKED_STATUS_SUCC_MSG = "Booked Status added successfully!";
export const UPDATE_BOOKED_STATUS_SUCC_MSG =
  "Booked Status updated successfully!";
export const FETCH_BOOKED_STATUS_ERR_MSG =
  "Failed to fetch booked status data!";
export const DUPLICATE_BOOKED_STATUS = "Booked Status already exists!";

//ToothConditionMaster

export const ADD_TOOTH_CONDITION_SUCC_MSG =
  "Tooth Condition added successfully!";
export const UPDATE_TOOTH_CONDITION_SUCC_MSG =
  "Tooth Condition updated successfully!";
export const FETCH_TOOTH_CONDITION_ERR_MSG =
  "Failed to fetch tooth condition data!";
...
export const DUPLICATE_DRUG_WARNING =
  "This drug is already added in another row. Please select a different drug.";
export const MINIMUM_ROWS_WARNING = "At least one row is required";
export const EMPTY_DRUG_NAME_WARNING =
  "Please fill drug name before adding new row";
...
export const EXCEED_STOCK_ERROR =
  "Required quantity cannot exceed available stock";
export const MANDATORY_FIELD_WARNING =
  "Please fill the Mandatory field before ";
export const DUPLICATE_DRUGS_WARNING =
  "Duplicate drugs found. Please remove duplicate entries before ";
export const NO_VALID_DRUGS_WARNING = "Please select valid drugs before ";
export const INDENT_SAVE_SUCCESS =
  "Indent saved successfully! Do you want to print report ?";
export const INDENT_SUBMIT_SUCCESS =
...
export const NO_ROL_DATA =
  "No items found below reorder level. All items have sufficient stock.";
export const IMPORT_FROM_PREVIOUS =
  "Import from Previous Indent feature coming soon";
export const FETCH_ITEM_ERR_MSG = "Error fetching items";
export const FETCH_ITEM_DETAILS_ERR_MSG = "Failed to load item details";
export const INDENT_TYPE_CHANGE_WARN_MSG =
  "If you switch the indent type, your entered data will be lost. Do you want to continue?";
export const INDENT_TYPE_MANDARORY_WARN_MSG =
  "Please select indent type before adding items";

//Blood GAROUP Master

export const FETCH_BLOOD_GROUP_ERR_MSG = "Failed to load blood group data";
export const DUPLICATE_BLOOD_GROUP =
  "Blood group with the same name already exists!";
...
export const DUPLICATE_DEPARTMENT_TYPE =
  "Department type with the same name already exists!";
export const UPDATE_DEPARTMENT_TYPE_SUCC_MSG =
  "Department type updated successfully!";
export const ADD_DEPARTMENT_TYPE_SUCC_MSG =
  "New department type added successfully!";
...
export const DUPLICATE_FREQUENCY =
  "Frequency with the same name already exists!";
...
export const FAILED_TO_LOAD_SELECTED_COUNTRY =
  "Failed to load states for selected country";
...
export const VALID_GST_RATE =
  "Please enter a valid GST Rate between 0 and 100.";

//Identification Master
export const FETCH_IDENTIFICATION_ERR_MSG =
  "Failed to load identification data";
export const DUPLICATE_IDENTIFICATION =
  "Identification with the same name already exists!";
export const UPDATE_IDENTIFICATION_SUCC_MSG =
  "Identification updated successfully!";
export const ADD_IDENTIFICATION_SUCC_MSG =
  "New identification added successfully!";

//Investigation Pricing Master
export const FETCH_INV_PRICING_ERR_MSG =
  "Failed to load investigation pricing data";
export const UPDATE_INV_PRICING_SUCC_MSG =
  "Investigation pricing updated successfully!";
export const ADD_INV_PRICING_SUCC_MSG =
  "New investigation pricing added successfully!";
...
export const FETCH_MARITAL_STATUS_ERR_MSG =
  "Failed to load marital status data";
export const DUPLICATE_MARITAL_STATUS =
  "Marital status with the same name already exists!";
export const UPDATE_MARITAL_STATUS_SUCC_MSG =
  "Marital status updated successfully!";
export const ADD_MARITAL_STATUS_SUCC_MSG =
  "New marital status added successfully!";
...
export const FETCH_PACKAGE_INV_ERR_MSG =
  "Failed to load package investigation data";
export const UPDATE_PACKAGE_INV_SUCC_MSG =
  "Package investigation updated successfully!";
export const ADD_PACKAGE_INV_SUCC_MSG =
  "New package investigation added successfully!";
export const SOME_INVESTIGATIONS_INVALID =
  "Some investigation IDs were invalid";
export const SELECT_A_PACKAGE_AT_LEAST_ONE_INVESTIGATION =
  "Please select a package and at least one investigation";
export const DUPLICATE_INV =
  "Duplicate investigation ! Investigation already exists in that package";
...
export const DUPLICATE_RELATIONSHIP =
  "Relationship with the same name already exists!";
export const UPDATE_RELATIONSHIP_SUCC_MSG =
...
//Service Category
export const UPDATE_SERVICE_CATEGORY_SUCC_MSG =
  "Service category updated successfully!";
export const ADD_SERVICE_CATEGORY_SUCC_MSG =
...
export const FETCH_USER_DEPARTMENT_ERR_MSG =
  "Failed to load user department data";
export const DUPLICATE_USER_DEPARTMENT =
  "User department with the same name already exists!";
export const UPDATE_USER_DEPARTMENT_SUCC_MSG =
  "User department updated successfully!";
export const ADD_USER_DEPARTMENT_SUCC_MSG =
  "New user department added successfully!";
...
export const ADD_LAB_AMENDMENT_TYPE_SUCC_MSG =
  "Amendment type added successfully!";
export const UPDATE_LAB_AMENDMENT_TYPE_SUCC_MSG =
  "Amendment type updated successfully!";
export const DUPLICATE_LAB_AMENDMENT_TYPE =
  "Amendment type code is already exists!";
export const FETCH_LAB_AMENDMENT_TYPE_ERR_MSG =
  "Failed to fetch amendment types";

//Patient Preparation Master

export const ADD_PREPARATION_SUCC_MSG =
  "Patient preparation added successfully!";
export const UPDATE_PREPARATION_SUCC_MSG =
  "Patient preparation updated successfully!";
export const DUPLICATE_PREPARATION_CODE = "Preparation code already exists!";
export const FETCH_PREPARATION_ERR_MSG =
  "Failed to fetch patient preparations.";

//Lab Report
export const SELECT_DATE_WARN_MSG = "Please select both From Date and To Date";
export const FETCH_LAB_HISTORY_REPORT_ERR_MSG =
  "Error fetching lab reports. Please try again.";
export const INVALID_DATE_PICK_WARN_MSG = "From Date cannot be after To Date";

//Lab TAT Report

export const FETCH_LAB_TAT_SUMMARY_REPORT_ERR_MSG =
  "Error fetching summary report. Please try again.";
export const FETCH_LAB_TAT_DETAILED_REPORT_ERR_MSG =
  "Error fetching detail report. Please try again.";

//Result Amendment Report

export const FETCH_AMEND_REPORT_ERR_MSG =
  "Error fetching result amendment report. Please try again.";

//Lab Order Tracking Report

export const FUTURE_DATE_PICK_WARN_MSG = "Date cannot be in the future";
export const PAST_DATE_PICK_WARN_MSG =
  "To date cannot be earlier than From date";
export const SELECT_FROM_DATE_FIRST_WARN_MSG = "Please select From Date first";
export const FETCH_ORDER_TRACKING_ERR_MSG =
  "Failed to fetch order tracking report. Please try again.";
export const SELECT_FIELD_WARN_MSG =
  "Please enter either Patient Name or Mobile Number";

//PendingInvestigationReport

export const FETCH_PENDING_INVESTIGATIONS_ERR_MSG =
  "Failed to fetch incomplete investigations report. Please try again.";

//SampleRejectionReport

export const FETCH_SAMPLE_REJECT_ERR_MSG =
  "Failed to fetch sample rejection report. Please try again.";

//OPD Patient Appointment

//reschedule and cancel appointment
export const INVALID_MOBILE_NUMBER =
  "Please enter a valid 10-digit mobile number";
export const FETCH_APPOINTMENT_ERROR = "Error fetching data. Please try again.";
export const NO_APPOINTMENTS_FOUND =
...
export const NO_TOKENS_AVAILABLE_TEXT =
  "No tokens available for the selected criteria.";
export const FETCH_TOKENS_ERROR =
  "Failed to fetch token availability. Please try again.";
...
export const SELECT_CANCELLATION_REASON =
...
export const NO_TIME_SLOTS =
  "No time slots available for this session and date.";

//appointment Setup
export const APPOINTMENT_REQUIRED_FIELDS =
  "Please fill all required fields properly for selected time slots.";
...
export const DUPLICATE_QUESTION_HEADING =
  "Question Heading Code already exists";
...
export const DUPLICATE_OB_CONCEPTION =
  "Conception with the same code or name  already exists";
...
export const FAIL_SOMTHING_OB_CONCEPTION =
...
export const DUPLICATE_ENTMAS =
  "Tonsil Grade   with the same code or name already exists";
...
export const DUPLICATE_CERVIX =
  "cervix Position with the same code or name  already exists";
...
export const UPDATE_IMMUNISATION_SUCC_MSG =
  "Immunisation status updated successfully!";
export const ADD_IMMUNISATION_SUCC_MSG =
  "Immunisation status added successfully!";

//SmearResultMaster
export const FETCH_SMEARRESULT = "Fail to fetch records";
export const DUPLICATE_SMEARRESULT =
  "sumerresult with the same code or name  already exists";
...
export const DUPLICATE_EARWEB =
  "EarWeberMaster with the same code or name  already exists";
...
export const DUPLICATE_BLOOD_DONATION_STATUS =
  "Status Code or Status Name already exists";
...
export const DUPLICATE_BLOOD_COMPATIBILITY =
  "Compatibility record already exists!";
...
export const DUPLICATE_BAG_TYPE_MASTER =
  "Bag Type or Status Name already exists";
...
export const AT_LEAST_ONE_APPOINTMENT_REQUIRED =
  "At least one appointment row is required";
export const INVALID_MOBILE_NUMBER_MSG =
...
export const SELECT_PATIENT_TO_UPDATE_ERROR =
  "Please select a patient to update";
export const ADD_AT_LEAST_ONE_APPOINTMENT_ERROR =
...
export const PATIENT_UPDATE_WITH_APPOINTMENT_SUCCESS =
  "Patient updated and appointments scheduled successfully!";
export const PATIENT_UPDATE_SUCCESS =
...
export const MAX_LENGTH_EXCEEDED_ERROR_TEXT =
  "Some data exceeds the maximum allowed length. Please check particularly long text fields.";
export const FAILED_TO_UPDATE_PATIENT_ERROR =
  "Failed to update patient. Please try again.";
export const NO_TOKENS_AVAILABLE_INFO =
  "No tokens are available for the selected session.";
export const FETCH_TOKEN_AVAILABILITY_ERROR =
  "Failed to fetch token availability. Please try again.";
export const SELECT_TOKEN_ERROR_LOG = "Error selecting token:";
export const SELECT_TOKEN_ERROR_TEXT =
  "Failed to select token. Please try again.";
export const SELECT_SPECIALITY_DOCTOR_SESSION_MSG =
  "Please select Speciality, Doctor, and Session first.";
export const FETCH_TOKEN_AVAILABILITY_ERROR_LOG =
  "Error fetching token availability.";
...
export const FETCH_CANCELLATION_REASONS_ERROR_LOG =
  "Error fetching cancellation reasons:";
export const NO_TOKENS_AVAILABLE_CRITERIA_MSG =
  "No tokens available for the selected criteria.";
export const NO_TIME_SLOTS_AVAILABLE_MSG =
  "No available time slots for the selected criteria. Please try another date or session.";
export const DUPLICATE_CHECK_FAILED_LOG = "Duplicate check failed:";
export const SELECT_TIME_SLOTS_BEFORE_REGISTRATION_MSG =
  "Please select time slots for all appointments before registration.";
export const INCOMPLETE_FORM_TITLE = "Incomplete Form";
export const INCOMPLETE_FORM_MSG = "Please fill all required fields.";
export const PATIENT_REGISTERED_SUCCESS_TITLE =
  "Patient Registered Successfully!";
export const UNEXPECTED_RESPONSE_MSG =
  "Unexpected response received. Please try again.";
export const PATIENT_REGISTRATION_FAILED_MSG =
  "Something went wrong while registering the patient. Please try again.";
export const NO_TOKENS_SELECTED_SESSION_MSG =
  "No tokens are available for the selected session.";
export const PIN_CODE_INVALID_MSG = "Pin Code must be exactly 6 digits.";
export const MOBILE_NUMBER_INVALID_MSG =
  "Mobile number must be exactly 10 digits.";
...
export const PHYSICAL_STOCK_SAVE_TITLE =
  "Physical Stock Adjustment Saved successfully";
export const PHYSICAL_STOCK_SAVE_FILE_NAME =
  "Physical Stock Adjustment Save Report";
export const PHYSICAL_STOCK_SUBMIT_TITLE =
  "Physical Stock Adjustment submitted successfully";
export const PHYSICAL_STOCK_SUBMIT_FILE_NAME =
  "Physical Stock Adjustment submit Report";
...
export const DEFERAL_REQUIRED_MSG =
  "Deferral Reason is required when screen fails";
export const DEFERAL_TYPE_REQUIRED_MSG =
  "Deferral Type is required when screen fails";

//indentissue
export const ERROR_MESSAGES = {
  DEPARTMENT_NOT_FOUND: "Department not found. Please login again.",
};
export const ERROR_FETCHING_INDENTS =
  "Error fetching indents. Please try again.";
export const CONFIRM_ISSUE_INDENT =
  "Are you sure you want to issue this indent? This will issue the full approved quantity for all selected items.";
export const CONFIRM_INDENT_ISSUED_PRINT =
...
export const ERROR_ITEM_ID_MISSING =
  "Item ID is missing. Cannot fetch previous issues.";

//openingbalance
export const WARNING_SELECT_ACTION =
  "Please select an action (Approve or Reject)";
export const WARNING_REMARKS_MANDATORY = "Remarks are mandatory";
export const CONFIRM_OPENING_BALANCE_ACTION = (actionText) =>
...
export const ERROR_PROCESS_REQUEST_FAILED =
...
export const WARNING_DOM_DOE_VALIDATION =
  "Date of Manufacturing (DOM) cannot be later than Date of Expiry (DOE).";

//openingbalanceentry
export const WARNING_DUPLICATE_BATCH_ENTRY =
  "Duplicate entry found for Batch No/Serial No, DOM, and DOE.";
export const WARNING_CORRECT_ERRORS =
  "Please correct the errors and try again.";
export const CONFIRM_SAVE_OPENING_BALANCE =
  "Are you sure you want to save the opening balance?";
export const SUCCESS_OPENING_BALANCE_SAVED_PRINT =
...
export const CONFIRM_SUBMIT_OPENING_BALANCE =
  "Are you sure you want to submit the opening balance?";
export const SUCCESS_OPENING_BALANCE_SUBMITTED_PRINT =
  "Opening Balance submitted successfully! Do you want to print report ?";
export const ERROR_SUBMIT_DATA_FAILED =
  "Failed to submit data. Please try again.";

//pendingindent
export const ERROR_FETCH_PENDING_INDENTS =
  "Error fetching pending indents. Please try again.";
export const SUCCESS_INDENT_REJECTED_PRINT =
  "Indent rejected successfully! Do you want to print report ?";
export const SUCCESS_INDENT_APPROVED_PRINT =
  "Indent approved successfully! Do you want to print report ?";
export const ERROR_PROCESS_INDENT =
  "Error processing indent. Please try again.";

//itemrecieving
export const ERROR_DEPARTMENT_ID_NOT_FOUND =
  "Department ID not found. Please login again.";
export const ERROR_FETCH_INDENTS = "Error fetching indents. Please try again.";
export const CONFIRM_SAVE_INDENT_RECEIVING =
  "Are you sure you want to save the receiving for this indent?";
export const SUCCESS_RECEIVING_SAVED_PRINT =
  "Receiving saved successfully! Do you want to print report ?";
export const ERROR_SAVE_RECEIVING_FAILED = "Failed to save receiving";
export const ERROR_SAVING_RECEIVING =
  "Error saving receiving. Please try again.";
export const ERROR_FETCH_INDENT_DETAILS =
  "Error fetching indent details. Please try again.";

//viewupdate
export const WARNING_DRUG_ALREADY_ADDED =
  "This drug is already added in another row. Please select a different drug.";
export const ERROR_AT_LEAST_ONE_ITEM_REQUIRED =
  "Please add at least one item with requested quantity";
export const SUCCESS_INDENT_SAVED_PRINT =
  "Indent saved successfully! Do you want to print report ?";
export const SUCCESS_INDENT_SUBMITTED_PRINT =
  "Indent submitted successfully! Do you want to print report ?";
...
export const FETCH_RADIOLOGY_TEMPLATE_ERR_MSG =
  "Failed to fetch radiology template data";
export const ADD_RADIOLOGY_TEMPLATE_SUCC_MSG =
  "Radiology template added successfully!";
export const UPDATE_RADIOLOGY_TEMPLATE_SUCC_MSG =
  "Radiology template updated successfully!";
export const DUPLICATE_RADIOLOGY_TEMPLATE =
  "A template with this code or name already exists";
...
export const PHYSICAL_STOCK_SAVE_MSG =
  "Are you sure you want to save the stock adjustment?";
export const PHYSICAL_STOCK_SAVE_SUCC_MSG =
  "Stock adjustment saved successfully! Do you want to print report?";
export const PHYSICAL_STOCK_SUBMIT_MSG =
  "Are you sure you want to submit the stock adjustment?";
export const PHYSICAL_STOCK_SUBMIT_SUCC_MSG =
...
export const FROM_DATE_LATER_THAN_TO_DATE_ERR_MSG =
  "From Date cannot be later than To Date";
export const FUTURE_DATE_ERR_MSG = "Dates cannot be in the future";
export const HOSPITAL_DEPT_REQUIRED_ERR_MSG =
  "Hospital and Department must be selected.";
...
export const OPENING_BALANCE_REGISTER_PDF_NAME =
  "Opening Balance Register Report";
...
export const REPORT_SAVE_FAILED_ERR_MSG =
  "Failed to save report. Please try again.";
export const REPORT_SUBMIT_FAILED_ERR_MSG =
  "Failed to submit report. Please try again.";

//PendingListRadiologyReportPage

export const FETCH_PENDING_LIST_ERR_MSG =
  "Failed to fetch pending list. Please try again.";
export const FAIL_TO_LOAD_DOCTORS_ERR_MSG =
  "Failed to load doctors. Please try again.";
export const EXCEDED_MONTH_SELECTION_WARN = (month) =>
  `Selected date range exceeds ${month} months.`;
...
export const DATA_NOT_FOUND_WRT_SELECTION_CRITERIA_WARN_MSG =
  "No data found for the selected criteria.";
export const FAIL_TO_LOAD_APPOINTMENT_SUMMARY_ERR_MSG =
  "Failed to fetch appointment summary";
export const REPORT_GENERATION_ERR_MSG =
...
export const SEARCH_CRITERIA_MANDATORY_WARN_MSG =
...
export const EXCEDED_DAY_SELECTION_WARN = (day) =>
  `Selected date range exceeds ${day} days.`;

//blood inventory status
export const FETCH_BLOOD_INVENTORY_STATUS =
  "Failed to load Blood Inventory Status";
export const UPDATE_BLOOD_INVENTORY_STATUS_SUCCESS =
  "Blood Inventory Status updated successfully";
export const ADD_BLOOD_INVENTORY_STATUS_SUCCESS =
  "Blood Inventory Status added successfully";
