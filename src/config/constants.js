...
//CROSSMatchType
export const FETCH_CROSS_MATCH = "Failed to fetch cross match types"
export const DUPLICATE_CROSS_MATCH_TYPE = "Cross match type with same code or name already exists";
export const UPDATE_CROSS_MATCH_TYPE = "Cross match type updated successfully"
export const ADD_CROSS_MATCH_TYPE = "Cross match type added successfully"
export const OPERATION_FAIL = "Operation failed"
export const FAIL_UPDATE_STATUS = "Failed to update status";
...
export const CONFIRM_OPENING_BALANCE_RESULT = (action) =>action === "a"
...
export const ERROR_SAVE_SUBMIT_INDENT = (backendStatus) =>`Error ${backendStatus === "S" ? "saving" : "submitting"} indent. Please try again.`;
...
// Blood Bank - Bag Component Generation Configuration & Master Aliases
export const BAG_COMPONENT_CONFIG = {
  SINGLE: ["WB"],
  DOUBLE: ["PRBC", "FFP"],
  TRIPLE: ["PRBC", "FFP", "PLT"],
  QUAD: ["PRBC", "FFP", "PLT", "CRYO"],
};

export const COMPONENT_ALIASES = {
  WB: ["WB", "WHOLE BLOOD"],
  PRBC: ["PRBC", "RBC", "PACKED RED BLOOD CELLS"],
  FFP: ["FFP", "PLASMA", "FP", "FRESH FROZEN PLASMA"],
  PLT: ["PLT", "PLATELET", "PLATELETS", "PLATELET CONCENTRATE", "RDP"],
  CRYO: ["CRYO", "CRYOPRECIPITATE"],
};

export const FALLBACK_COMPONENT_NAMES = {
  WB: "Whole Blood",
...
// Blood Bank - Tracking Status IDs
export const TRACKING_STATUS_REQUEST = 1;
export const BLOOD_REQUEST_TRACKING_STATUS_REQUEST = 1;
export const TRACKING_STATUS_ID_REQUEST = 1;
export const BLOOD_BANK_TRACKING_STATUS = {
  REQUEST: 1,
  CROSS_MATCHING: 2,
  COMPATIBILITY_TESTING: 3,
  ISSUED: 4,
  REJECTED: 5,
};

// Blood Bank - Cross Match Result Constants & Dropdown Options
export const CROSS_MATCH_RESULT_COMPATIBLE = "Compatible";
export const CROSS_MATCH_RESULT_INCOMPATIBLE = "Incompatible";
export const CROSS_MATCH_RESULT_PENDING = "Pending";

export const CROSS_MATCH_RESULTS = {
  COMPATIBLE: CROSS_MATCH_RESULT_COMPATIBLE,
  INCOMPATIBLE: CROSS_MATCH_RESULT_INCOMPATIBLE,
  PENDING: CROSS_MATCH_RESULT_PENDING,
};

export const CROSS_MATCH_RESULT_OPTIONS = [
  { value: "", label: "Select Result" },
  { value: CROSS_MATCH_RESULT_COMPATIBLE, label: "Compatible" },
  { value: CROSS_MATCH_RESULT_INCOMPATIBLE, label: "Incompatible" },
  { value: CROSS_MATCH_RESULT_PENDING, label: "Pending" },
];

export const CROSS_MATCH_SEARCH_RESULT_OPTIONS = [
  { value: "", label: "All Cross-Match Results" },
  { value: CROSS_MATCH_RESULT_COMPATIBLE, label: "Compatible" },
  { value: CROSS_MATCH_RESULT_INCOMPATIBLE, label: "Incompatible" },
  { value: CROSS_MATCH_RESULT_PENDING, label: "Pending" },
];

export const CROSS_MATCH_SEARCH_OPTIONS = CROSS_MATCH_SEARCH_RESULT_OPTIONS;

export const DEFAULT_CROSS_MATCH_TYPES = [
  { id: 39, crossMatchCode: "ABO", crossMatchName: "ABO Compatibility Test", isEmergencyAllowed: "Y" },
  { id: 16, crossMatchCode: "AHG", crossMatchName: "AHG Crossmatch", isEmergencyAllowed: "N" },
  { id: 41, crossMatchCode: "ABS", crossMatchName: "Antibody Screen", isEmergencyAllowed: "N" },
  { id: 42, crossMatchCode: "AUTO", crossMatchName: "Auto Control", isEmergencyAllowed: "N" },
  { id: 35, crossMatchCode: "CAT", crossMatchName: "Column Agglutination Crossmatch", isEmergencyAllowed: "N" },
  { id: 38, crossMatchCode: "COMP", crossMatchName: "Computer Crossmatch", isEmergencyAllowed: "N" },
  { id: 36, crossMatchCode: "DGEL", crossMatchName: "DG Gel Crossmatch", isEmergencyAllowed: "N" },
  { id: 18, crossMatchCode: "ELEC", crossMatchName: "Electronic Crossmatch", isEmergencyAllowed: "N" },
  { id: 17, crossMatchCode: "ENZ", crossMatchName: "Enzyme Crossmatch", isEmergencyAllowed: "N" },
  { id: 33, crossMatchCode: "IS", crossMatchName: "Immediate Spin Crossmatch", isEmergencyAllowed: "Y" },
  { id: 34, crossMatchCode: "IAT", crossMatchName: "Indirect Antiglobulin Crossmatch", isEmergencyAllowed: "N" },
  { id: 40, crossMatchCode: "RH", crossMatchName: "Rh Compatibility Test", isEmergencyAllowed: "Y" },
  { id: 37, crossMatchCode: "TUBE", crossMatchName: "Tube Crossmatch", isEmergencyAllowed: "N" },
];


>>>>>>> 3ccf09e (blood bank changes)
