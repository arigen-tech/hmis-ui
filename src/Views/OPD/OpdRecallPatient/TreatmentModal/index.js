...
const TreatmentModal = ({
  ...
  const mockTemplates = [
    {
      templateId: 1,
      opdTemplateName: "Pain Management",
      opdTemplateCode: "PM001",
      treatments: [
        {
          itemId: 1,
          dosage: "1",
  ...
  const mockDrugs = [
    {
      id: 1,
      name: "Diclofenac Sodium Tab. IP 50 mg",
      code: "D168",
      dispUnitName: "Tab",
      dispUnitId: 1,
      itemClassId: 1,
      adispQty: 1,
      nomenclature: "Diclofenac Sodium Tab. IP 50 mg",
      pvmsNo: "D168"
    },
    {
      id: 2,
      ...
      itemClassId: 1,
      adispQty: 1,
      nomenclature: "TAB CETIRIZINE 10 MG",
      pvmsNo: "D00162"
    },
    {
      id: 3,
      name: "Ferrous Sulphate with Folic Acid Tab.",
      code: "D00078",
      dispUnitName: "Tab",
      dispUnitId: 1,
      itemClassId: 1,
      adispQty: 1,
      nomenclature: "Ferrous Sulphate with Folic Acid Tab.",
      pvmsNo: "D00078"
    }
  ]

  const mockFrequencies = [
    { frequencyId: 1, frequencyName: "OD", feq: 1 },
    { frequencyId: 2, frequencyName: "BID", feq: 2 },
    { frequencyId: 3, frequencyName: "TID", feq: 3 },
    { frequencyId: 4, frequencyName: "QID", feq: 4 },
    { frequencyId: 5, frequencyName: "HS", feq: 1 },
    { frequencyId: 6, frequencyName: "SOS", feq: 1 }
  ]

  const DRUG_TYPE = {
    SOLID: [1, 2], // Tablet, Capsule
    LIQUID: [3, 4] // Syrup, Injection
  }
  ...
  const fetchAllFrequencies = async () => {
    try {
      ...
      // Mock API call
      setTimeout(() => {
        setAllFrequencies(mockFrequencies)
        setLoading(false)
      }, 500);
    } catch (error) {
