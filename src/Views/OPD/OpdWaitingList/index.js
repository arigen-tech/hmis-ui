...
import { useEffect, useState } from "react";
import Popup from "../../../Components/popup";
import TreatmentModal from "../../../Components/TreatmentModal"; // Adjust the path as needed
import { GET_WAITING_LIST } from "../../../config/apiConfig";
...
const OpdWaitingList = () => {
  ...
  const handleViewTreatment = (visit) => {
    // Pass the treatment data to the modal
    setSelectedTreatment(visit.treatment || null)
  ...
  return (
    <div className="content-wrapper">
      ...
      {/* Treatment Modal - Medication View Mode */}
      <TreatmentModal
        ...
        selectedTemplate={selectedTreatment}
      />
