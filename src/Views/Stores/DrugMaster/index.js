...
const Drugmaster = () => {
    const [itemType, setItemType] = useState([
        { id: 1, itemType: "T1", itemTypeCode: "MEDICAL ASSET", itemTypeName: "ASSET", status: "y" },
        { id: 2, itemType: "T2", itemTypeCode: "MEDICAL ASSET", itemTypeName: "ASSET", status: "y" },
        { id: 3, itemType: "T3", itemTypeCode: "MEDICAL ASSET", itemTypeName: "ASSET", status: "y" },
        { id: 4, itemType: "T4", itemTypeCode: "NON MEDICAL ASSET", itemTypeName: "CONSUMABLE", status: "y" },
        { id: 5, itemType: "T5", itemTypeCode: "NON MEDICAL ASSET", itemTypeName: "CONSUMABLE", status: "y" },
    ]);
    ...
    const filteredItemType = itemType.filter(itemType =>
        itemType.itemTypeName.toLowerCase().includes(searchQuery.toLowerCase()) ||
        itemType.itemTypeCode.toLowerCase().includes(searchQuery.toLowerCase())
    );
                ...
                <div className="col-12 grid-margin stretch-card">
                    <div className="card form-card">
                        <div className="card-header">
                            ...
                            <div className="d-flex justify-content-between align-items-spacebetween mt-3">
                                <div className="d-flex align-items-center">
                                    <div className="me-3">
                                        <label>
                                            <input type="radio" name="searchType" value="code" />
                                            <span style={{ marginLeft: '5px' }}>Mat. Code</span>
                                        </label>
                                    </div>
                                    <div className="me-3">
                                        <label>
                                            <input type="radio" name="searchType" value="" />
                                            <span style={{ marginLeft: '5px' }}>Nomenclature</span>
                                        </label>
                                    </div>
                                </div>
                                <div className="d-flex align-items-center">
                                ...
                                <div className="form-group col-md-4">
                                    <label htmlFor="templateSelect">Item Group <span className="text-danger">*</span></label>
                                    <select
                                        className="form-control"
                                        id="templateSelect"
                                        required
                                ...
                                <div className="table-responsive packagelist">
                                    ...
                                    <div className="row">
                                        <div className="form-group col-md-4 mt-3">
                                            <label>Item Type Code <span className="text-danger">*</span></label>
                                            <input
                                                type="text"
                                                className="form-control"
                                                id="itemclasscode"
