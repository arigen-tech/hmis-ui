            ...
            <form onSubmit={handleSave}>
              <div className="row">
                <div className="col-md-4">
                  ...
                  <input className="form-control" name="corporateName" value={formData.corporateName} onChange={handleInputChange} />
                </div>

                <div className="col-md-4">
                  <label>Code</label>
                  <input className="form-control" name="code" value={formData.code} onChange={handleInputChange} />
                </div>

                <div className="col-md-4">
                  <label>Contact Person</label>
                  <input className="form-control" name="contactPerson" value={formData.contactPerson} onChange={handleInputChange} />
                </div>

                <div className="col-md-4">
                  <label>Contact No</label>
                  <input className="form-control" name="contactNo" value={formData.contactNo} onChange={handleInputChange} />
                </div>
