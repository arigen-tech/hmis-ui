...
const Investigationpricing = () => {
  const [investigationList, setInvestigationList] = useState([
    { id: 1, investigationId: "1", fromDate: "-", toDate: "-", price: "23", status: "y" },
    { id: 2, investigationId: "2", fromDate: "-", toDate: "-", price: "2342", status: "y" },
    { id: 3, investigationId: "3", fromDate: "-", toDate: "-", price: "23422", status: "y" },
    { id: 4, investigationId: "4", fromDate: "-", toDate: "-", price: "4323", status: "y" },
    { id: 5, investigationId: "5", fromDate: "-", toDate: "-", price: "2342", status: "y" },
  ])
