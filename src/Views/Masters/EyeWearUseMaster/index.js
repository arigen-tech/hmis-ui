...
const EyeWearUseMaster = () => {
  ...
  const filteredData = data.filter((rec) => rec.use_name.toLowerCase().includes(searchQuery.toLowerCase()));
  ...
  // --- Show confirmation popup before changing status ---
  ...
  const resetForm = () => {
    setFormData({ use_name: "", created_by: "", last_updated_by: "", status: "Y" });
    ...
    <div className="content-wrapper">
      <div className="card form-card">
        <div className="card-header d-flex justify-content-between align-items-center">
          <h4 className="card-title">Eye Wear Use Master</h4>
          <div className="d-flex align-items-center">
            {!showForm && <input type="text" className="form-control w-50 me-2" placeholder="Search by Use Name" value={searchQuery} onChange={handleSearchChange} />}
            {!showForm ? (
              <>
          ...
          {!showForm ? (
            ...
            <form className="row" onSubmit={handleSave}>
              <div className="form-group col-md-4">
                <label>Use Name <span className="text-danger">*</span></label>
...
export default EyeWearUseMaster;
